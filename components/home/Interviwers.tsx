      ...
      <CardBody>
        ...
        <div className='flex items-center gap-6 flex-col'>
          {loading ? (
            ...
            <>
              <span className='text-sm mt-3 text-center'>Stay updated with the most recent interviewers who are actively participating in the hiring process to ensure you get the best candidates.</span>
