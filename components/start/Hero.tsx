...
export const Hero: React.FC = () => {
  return (
    <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-25 text-center lg:pt-32'>
      ...
      <p className='mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700'>Most hiring tools require too much effort. We make the opposite trade-off—AI streamlines everything, making hiring effortless.</p>
