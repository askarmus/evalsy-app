...
export const DarkModeSwitch = () => {
  ...
  return <Switch isSelected={resolvedTheme === "dark"} color='primary' size='sm' onValueChange={(e) => setTheme(e ? "dark" : "light")} thumbIcon={({ isSelected, className }) => (isSelected ? <SunIcon className={className} /> : <MoonIcon className={className} />)} />;
};
