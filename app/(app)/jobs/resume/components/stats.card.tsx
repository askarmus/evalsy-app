  ...
  const cards = [
    {
      ...
      icon: <FaUsers className='h-6 w-6 text-sky-500 dark:text-sky-400' />,
    ...
    },
    {
      ...
      icon: <FaChartLine className='h-6 w-6 text-teal-500 dark:text-teal-400' />,
    ...
    },
    {
      ...
      icon: <FaStar className='h-6 w-6 text-amber-500 dark:text-amber-400' />,
    ...
    },
    {
      ...
      icon: <FaUserSlash className='h-6 w-6 text-rose-500 dark:text-rose-400' />,
