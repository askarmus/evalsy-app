      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm font-medium">{Math.floor(selectedInterviewerData?.overallWeight)}</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm font-medium">{selectedInterviewerData?.fraudProbability}%</span>
          </div>
        </div>
      </div>
    </div>
