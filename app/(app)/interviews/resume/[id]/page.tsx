  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <Button variant="flat" onPress={() => setSortOrder((prev) => (prev === 'asc' ? 'desc' : 'asc'))}>
          {sortOrder === 'asc' ? 'Ascending ↑' : 'Descending ↓'}
        </Button>

        <div className="flex-1" />

        <Button color="danger" variant="flat" isDisabled={selectedKeys === 'all' ? filteredAndSorted.length === 0 : (selectedKeys as Set<React.Key>).size === 0} onPress={handleBulkDelete}>
          Delete selected
        </Button>
