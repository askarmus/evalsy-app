        ...
        <CardBody>
          <div className="grid lg:grid-cols-4 gap-3">
            <div className="col-span-1 p-4">
              <nav className="flex flex-row lg:flex-col gap-2 w-auto lg:w-full bg-secondary-300 p-1.5 rounded-xl" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
