...
export const Testimonials = () => {
  ...
  return (
    <section id="testimonials" aria-labelledby="faq-title" className="relative overflow-hidden bg-[#1e1237] on-home-v2 py-20 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <div className="mx-auto max-w-3xl lg:mx-0">
          <h2 id="faq-title" className="font-display text-4xl font-semibold  sm:text-4xl text-white">
            What people are saying about us.
          </h2>
          <p className="mt-4 text-lg text-white ">If you cant find what you are looking for, email our support team and if you are lucky someone will get back to you.</p>
        </div>
        <div className="flex flex-wrap -m-4 mt-8">
          {columns.map((column, columnIndex) => (
            <div key={columnIndex} className="w-full p-4 md:w-1/3">
              {column.map((testimonial) => (
                <div key={testimonial.id} className="p-6  on-home-v22  rounded-2xl text-white  mb-4">
