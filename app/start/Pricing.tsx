    ...
    <section id="pricing" className="bg-darkbase-sec py-20 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="font-display text-4xl font-bold  sm:text-4xl" style={{ fontFamily: 'Courier, monospace' }}>
          ...
          <div className=" p-8 border-2 border-black rounded-lg  bg-white">
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li className="flex items-center">
                <AiOutlineCheckCircle className="text-green-500 mr-3 h-5 w-5" />
                10 free credits
              </li>
              <li className="flex items-center">
                <AiOutlineCheckCircle className="text-green-500 mr-3 h-5 w-5" />
        ...
        <div className="mt-10 text-center">
          <Link className="mt-8 text-white  bg-black round-sm rounded-lg py-2 px-6 font-medium   hover:   hover:bg-slate-600 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-700" href="/signup">
            Try for free
          </Link>
