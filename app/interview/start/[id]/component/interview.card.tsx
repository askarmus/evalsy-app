...
const InterviewCard: React.FC<InterviewCardProps> = ({ invitationDetails, onStartButtonClick, loading }) => {
        ...
        <Card className='p-8' shadow='none'>
          ...
          <CardBody>
            <div className='mb-5'>
              ...
              <ul className='list-disc list-inside text-gray-700 space-y-1'>
                <li>
                  <strong>Duration:</strong> {invitationDetails.duration} minutes
                </li>
                <li>
                  <strong>Total Questions:</strong> {invitationDetails.job.questions.length}
                </li>
              </ul>
            </div>
          ...
          <CardFooter>
            <div className='flex flex-col items-start space-y-2'>
              <Button onPress={onStartButtonClick} isDisabled={!isChecked} color='primary' isLoading={loading}>
                Start Interview
              </Button>
