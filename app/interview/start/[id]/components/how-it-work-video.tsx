...
export default function VideoModal() {
  ...
  return (
    <>
      <Button onPress={() => setIsOpen(true)} variant="bordered" size="lg" className="border-2 border-purple-500/50 text-purple-500 hover:bg-purple-500/20 px-8 py-4 text-lg font-semibold rounded-full backdrop-blur-sm bg-transparent">
