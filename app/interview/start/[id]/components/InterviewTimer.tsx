  ...
  return (
    <div className="flex items-center gap-2 w-full  pb-2   ">
      ...
      <div className="text-gray-600 flex-shrink-0">
        <Clock className="w-5 h-5 text-[#3534ff]" />
      </div>
      ...
      <div className="flex-1">
        ...
        <div className="flex justify-between items-center ">
          <p className="text-sm   font-semibold">Interview Time Left</p>
        ...
        <div className="mt-0 relative h-1 w-full bg-gray-300 rounded-full overflow-hidden">
          <div className="absolute left-0 top-0 h-full bg-[#a57dcc] transition-all duration-300" style={{ width: `${percentageLeft}%` }} />
